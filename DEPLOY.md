...
```bash
# Créer le repository sur GitHub puis configurer le remote
...
3. **Configuration du repository** :
   - Repository: `wadieelmasmodi/Landing-Page-Solaire`
   - Branch: `main`
...
- Vérifiez que le Dockerfile Path est correct : `./Dockerfile`
...
- **GitHub** : https://github.com/wadieelmasmodi/Landing-Page-Solaire
